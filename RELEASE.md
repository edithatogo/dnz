...
- The documented MSRV is Rust 1.94, matching the resolved Polars/Arrow/Parquet dependency floor and the Pixi environment contract. The hardening workflow runs a workspace check at this floor before publication.
