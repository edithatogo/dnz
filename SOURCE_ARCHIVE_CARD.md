...
# DigitalNZ Source Archive

This archive packages the checked-in DigitalNZ source trees for long-term citation and reuse.
...
- The archive scope can expand later if more DigitalNZ source-led trees are added to the repo.
