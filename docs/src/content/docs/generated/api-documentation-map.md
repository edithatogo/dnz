...
| `rnz/README.md` | RNZ archive bundle overview | Retained source artifact | Describes the curated RNZ archive bundle mirrored to public archives. |
| `rnz/*.csv` | RNZ collection and rights snapshot | Retained source artifacts | Capture the recording and document records derived from the facet exports. |
| `rnz/recordings.md` | RNZ recording inventory | Retained source artifact | Summarizes the RNZ recording and associated-document rows. |
...
- Use the RNZ archive bundle and family page together as documentation for the checked-in Radio New Zealand rows.
